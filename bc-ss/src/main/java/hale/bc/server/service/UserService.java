...
public class UserService implements UserDetailsService {
	...
	private final long EXPIRED_MILLISECOND = 1000*60*60*24*2;
	...
	public boolean passwordResettingExpired(User user) {
		return (new Date()).getTime() - user.getPwdCodeGeneratedTime() > EXPIRED_MILLISECOND;
	}
